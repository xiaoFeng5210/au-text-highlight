...
function useTextSelection(options) {
  ...
  var _c = useState(false),
    isSelecting = _c[0],
    setIsSelecting = _c[1];
  var getTriggerPosition = useCallback(function () {
...
var AuSelectionPopover = function (_a) {
  ...
  // 计算 Popover 位置
  var calculatePosition = useCallback(function (position) {
  ...
  var selectionChange = useCallback(function (selectionObj) {
    if (disabled) {
      setIsVisible(false);
      return;
    }
...
export { DrawWordConstituencyPopover, AuSelectionPopover as ReactAuSelectionPopover, auExtractHighlightText as auExtractText, getSelectionRange, getSelectionRangeContent, sectionRange as sectionRangeHighlight, useTextSelection };
